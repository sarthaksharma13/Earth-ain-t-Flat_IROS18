function write_inp_shape(X3d,avgCarHeight,avgCarWidth,avgCarLength,K,kps,meanshape,vectors,theta2,kp_lookup,l,pose)
% construct the input file for shape adjuster
fID = fopen('../../data/ceres_input_singleViewShapeAdjuster.txt','w');  %singleViewShapeAdjuster
fprintf(fID,'%d\n',36);
fprintf(fID,'%f %f %f\n',X3d(1),X3d(2),X3d(3));
